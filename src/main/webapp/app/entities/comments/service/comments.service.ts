...
export type PartialUpdateComments = Partial<IComments> & Pick<IComments, 'commentId'>;

type RestOf<T extends IComments | NewComments> = Omit<T, 'createdAt'> & {
...
export class CommentsService {
  ...
  getCommentsIdentifier(comments: Pick<IComments, 'commentId'>): number {
    return comments.commentId;
  }

  compareComments(o1: Pick<IComments, 'commentId'> | null, o2: Pick<IComments, 'commentId'> | null): boolean {
    return o1 && o2 ? this.getCommentsIdentifier(o1) === this.getCommentsIdentifier(o2) : o1 === o2;
  }

  addCommentsToCollectionIfMissing<Type extends Pick<IComments, 'commentId'>>(
